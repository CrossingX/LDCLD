...
HD_PWD=D:/vivado/vivado project/DemoPJ1/DemoPJ1.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log DemoPJ1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source DemoPJ1_wrapper.tcl -notrace

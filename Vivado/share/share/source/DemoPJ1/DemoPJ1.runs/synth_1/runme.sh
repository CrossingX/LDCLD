...
HD_PWD=D:/vivado/vivado project/DemoPJ1/DemoPJ1.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log DemoPJ1_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DemoPJ1_wrapper.tcl

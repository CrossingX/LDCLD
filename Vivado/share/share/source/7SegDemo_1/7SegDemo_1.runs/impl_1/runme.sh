...
HD_PWD=D:/vivado/vivado project/7SegDemo_1/7SegDemo_1.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log Demo_7Seg_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Demo_7Seg_wrapper.tcl -notrace

...
HD_PWD=D:/vivado/vivado project/7SegDemo_1/7SegDemo_1.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log Demo_7Seg_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Demo_7Seg_wrapper.tcl
